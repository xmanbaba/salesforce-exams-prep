      ...
      const fallbackQuestions = [
        {
          ...
          options: [
            "A. Feature A - Advanced automation capabilities",
            "B. Feature B - Enhanced security protocols", 
            "C. Feature C - Improved user interface",
            "D. Feature D - Better integration options"
          ],
          answer: "A",
          explanation: "Feature A provides the most comprehensive automation capabilities for this topic."
        },
        {
          question: `Which best describes the primary benefit of ${topic}?`,
          options: [
            "A. Cost reduction through efficiency",
            "B. Improved data accuracy and reliability",
            "C. Enhanced user experience and satisfaction", 
            "D. Better compliance and governance"
          ],
          answer: "B",
          explanation: "The primary benefit is improved data accuracy and reliability across all operations."
        },
        {
          question: `What is the recommended approach when implementing ${topic}?`,
          options: [
            "A. Start with a pilot program",
            "B. Implement everything at once",
            "C. Focus only on critical features",
            "D. Wait for next version release"
          ],
          answer: "A", 
          explanation: "Starting with a pilot program allows for testing and refinement before full deployment."
        },
        {
          question: `Which tool is most commonly used with ${topic}?`,
          options: [
            "A. Configuration management tool",
            "B. Data analysis platform",
            "C. User training portal",
            "D. Performance monitoring system"
          ],
          answer: "D",
          explanation: "Performance monitoring systems are essential for tracking and optimizing implementation."
        },
        {
          question: `What is the biggest challenge when working with ${topic}?`,
          options: [
            "A. Technical complexity and learning curve",
            "B. Cost and budget constraints", 
            "C. User adoption and change management",
            "D. Integration with existing systems"
          ],
          answer: "C",
          explanation: "User adoption and change management typically present the greatest challenges in any implementation."
        }
      ];
