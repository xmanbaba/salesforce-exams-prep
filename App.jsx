...
function App() {
  ...
  const handleStartQuiz = useCallback((examName, newQuestions, isRetake = false) => {
    ...
    // Randomize questions for retakes to address screenshot concern
  ...
  // Handle generating questions from AI with enhanced error handling
  ...
  // Handle new quiz (completely fresh questions)
  ...
  // Handle restart/retake quiz - generates NEW questions
